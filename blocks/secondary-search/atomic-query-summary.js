  ...
  const handlerSummaryTextChanges = () => {
    ...
    if (summaryText) {
      ...
      if (match) {
        ...
        resultTextElement.innerHTML = `<span style="margin-right: 40px;" class="search-result-left">Search Results for: ${searchQuery}</span> <span class="search-right">${pageText}</span>`;
