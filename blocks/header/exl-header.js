...
// const { defaultProfileClient, isSignedInUser, signOut } = profile
...
async function decorate() {
  ...
  exlHeader.shadowRoot.appendChild(headerWrapper);
  ...
  // This step is necessary to create the hamburguer Menu
  ...
  nav.innerHTML = headerFragment;

  const decorateHeaderBlock = async (className, decorator) => {
    const block = nav.querySelector(`:scope > div > .${className}`);
