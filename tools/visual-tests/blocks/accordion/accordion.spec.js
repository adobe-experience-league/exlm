...
test.describe('accordion Visual Tests', () => {
  ...
  test('accordion-group visual test at Mobile viewport', async ({ page }) => {
    // Set viewport size
    ...
    const block = await frame.waitForSelector('.accordion', { timeout: 30000, state: 'visible' });
    ...
    if (!box) throw new Error('Could not get bounding box for accordion');
    ...
    const screenshotName = 'accordion-0-Mobile.png';
  ...
  test('accordion-group visual test at Tablet viewport', async ({ page }) => {
    ...
    // Take a screenshot of only the block area
    const screenshotName = 'accordion-0-Tablet.png';
    const screenshot = await page.screenshot({
      clip: box,
      timeout: 30000,
      animations: 'disabled',
  ...
  test('accordion-group visual test at Desktop viewport', async ({ page }) => {
    ...
    // Take a screenshot of only the block area
    const screenshotName = 'accordion-0-Desktop.png';
    const screenshot = await page.screenshot({
      clip: box,
      timeout: 30000,
      animations: 'disabled',
  ...
  test('accordion-group visual test at Large viewport', async ({ page }) => {
    ...
    // Take a screenshot of only the block area
    const screenshotName = 'accordion-0-Large.png';
    const screenshot = await page.screenshot({
      clip: box,
      timeout: 30000,
      animations: 'disabled',
