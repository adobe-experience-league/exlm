/**
 * Country data utility module
 * Provides ISO 3166-1 alpha-2 country codes and names for profile management
 *
 * @module scripts/utils/country
 */
...
/**
 * Get country options formatted for Dropdown component
 * @returns {Array<{value: string, title: string, id: string}>} Array of country options
 */
 ...
 * @returns {string} ISO 3166-1 alpha-2 code or empty string if not found
 */
