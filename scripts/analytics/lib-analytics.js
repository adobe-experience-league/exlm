...
// TQ Tags
const productV2 = document.querySelector('meta[name="product-v2"]')?.content || '';
const subFeatureV2 = document.querySelector('meta[name="subfeature-v2"]')?.content.toLowerCase() || '';
const featureV2 = document.querySelector('meta[name="feature-v2"]')?.content.toLowerCase() || '';
const roleV2 = document.querySelector('meta[name="role-v2"]')?.content || '';
const levelV2 = document.querySelector('meta[name="level-v2"]')?.content || '';
const topicV2 = document.querySelector('meta[name="topic-v2"]')?.content || '';
const industryV2 = document.querySelector('meta[name="industry-v2"]')?.content || '';
