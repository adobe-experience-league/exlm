...
/** Main production Coveo routing — default on EXLM-5361 Events Search QA. */
...
/** Prod Coveo org / endpoint (Sarika prod dupe — EXLM-5359 / EXLM-5361). */
...
/**
 * EXLM-5361 QA branch only — Sarika prod API key (same as ticket curl).
...
/**
 * EXLM-5361 Events Search QA:
 * - Always route to prod Coveo org + platform.cloud.coveo.com (Sarika prod dupe).
...
export function initCoveoPipelineTestForEventsSearch() {
  ...
  // eslint-disable-next-line no-console
  console.info('[Coveo QA] EXLM-5361 Events Search routing', {
...
/** @deprecated Use initCoveoPipelineTestForEventsSearch on EXLM-5361 branch */
